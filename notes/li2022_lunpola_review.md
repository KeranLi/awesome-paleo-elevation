...
CrossRef 未返回摘要。题名已核验；该文以火山玻璃氢同位素为新证据，并对 Lunpola 盆地新生代古高程研究进行批判性评述。它是本库的首选综述入口，但具体高程曲线和争议结论必须从全文和补充材料核对。

## 阅读时重点

整理火山玻璃保存与校准假设、与碳酸盐/古生物代理的交叉验证，以及作者如何处理盆地沉积环境变化和水汽来源。

## 状态

metadata-only；待全文或出版社摘要。
